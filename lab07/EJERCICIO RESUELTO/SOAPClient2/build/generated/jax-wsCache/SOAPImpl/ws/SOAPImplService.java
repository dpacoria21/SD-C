 ...
 * 
 */
@WebServiceClient(name = "SOAPImplService", targetNamespace = "http://soap.rosamarfil.es/", wsdlLocation = "http://localhost:8080/WSSOAP/SOAPImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WSSOAP/SOAPImpl?wsdl");
